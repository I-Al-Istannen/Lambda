...
import com.jvmrally.lambda.command.utility.javadoc.formatting.JavadocMessageFormatter.Formatter;
import com.jvmrally.lambda.utility.StringUtils;
import com.jvmrally.lambda.utility.markdown.HtmlMarkdownConverter;
...
public class JavadocDescriptionFormatter implements Formatter {
    ...
    public void format(EmbedBuilder message, JavadocElement element) {
        element.getJavadoc()
                .ifPresent(javadocComment -> applyComment(javadocComment, message));
    }
