...
public class JavadocMessageFormatter {
    ...
    private BiConsumer<EmbedBuilder, JavadocElement> setColorAndImage(Color color, String url) {
    ...
    private void setEmbedColor(EmbedBuilder message, Color color) {
        message.setColor(color);
    }

    private void setImage(EmbedBuilder message, JavadocElement element, String url) {
        message.setAuthor(element.getDeclaration(), element.getUrl(), url);
    }
     ...
     */
    public void format(EmbedBuilder message, JavadocElement element) {
        formatters.stream()
    ...
    public interface Formatter {
         ...
         */
        void format(EmbedBuilder message, JavadocElement element);

        static Formatter of(Predicate<JavadocElement> predicate, Consumer<EmbedBuilder> action) {
            return of(predicate, (message, element) -> action.accept(message));
        }

        static Formatter of(Predicate<JavadocElement> predicate,
                            BiConsumer<EmbedBuilder, JavadocElement> action) {
